...
const Store = React.memo((props) => {
    ...
    const checkPagination = async()=>{
        if(paginationWork.current){
            let addedList = await getStores({skip: list.length, search})
    ...
    return (
        <App list={list} unsaved={unsaved} checkPagination={checkPagination} searchShow={true} pageName='Магазины' menuItems={menuItems} anchorElQuick={anchorElQuick} setAnchorElQuick={setAnchorElQuick}>
            <Head>

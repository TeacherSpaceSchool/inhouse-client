...
const MoneyRecipients = React.memo((props) => {
    ...
    return (
        <App unsaved={unsaved} checkPagination={checkPagination} list={list} searchShow={true} pageName='Получатели денег' menuItems={menuItems} anchorElQuick={anchorElQuick} setAnchorElQuick={setAnchorElQuick}>
            <Head>

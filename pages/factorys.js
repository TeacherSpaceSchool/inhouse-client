...
import {getFactorys, getFactorysCount, addFactory, setFactory, deleteFactory} from '../src/gql/factory'
...
const Factory = React.memo((props) => {
    ...
    const checkPagination = async()=>{
        if(paginationWork.current){
            let addedList = cloneObject(await getFactorys({skip: list.length, search}))
    ...
    //render
    return (
        <App unsaved={unsaved} checkPagination={checkPagination} searchShow={true} pageName='Фабрики' menuItems={menuItems} anchorElQuick={anchorElQuick} setAnchorElQuick={setAnchorElQuick}>
            <Head>
                <title>Фабрики</title>
